            ...
            for extension in &client_hello.extensions {
                match extension {
                    Extension::SupportedEllipticCurves(e) => {
                        ...
                        // Find the first curve we actually support, instead of
                        // blindly taking the client's first choice (which may be
                        // an unsupported curve like X25519Kyber768).
                        use crate::curve::named_curve::NamedCurve;
                        let mut found = false;
                        for curve in &e.elliptic_curves {
                            match curve {
                                NamedCurve::P256 | NamedCurve::P384 | NamedCurve::X25519 => {
